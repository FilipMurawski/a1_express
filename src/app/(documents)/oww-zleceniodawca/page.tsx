...
const Page = () => {
    ...
    return (
      <div className="flex flex-col items-center gap-4 justify-center min-h-screen p-4 bg-[var(--background)] text-[var(--foreground)]">
        <h1 className="text-2xl font-bold mb-4">{language === "PL" ? "Ogólne Warunki Współpracy - Zleceniodawca" : "A1 GENERAL TERMS OF COOPERATION - OUTSOURCER"}</h1>
        ...
        <embed
          src={language === "PL" ? "/A1 OGÓLNE WARUNKI WSPÓŁPRACY - ZLECENIODAWCA.pdf" : "/A1 OGÓLNE WARUNKI WSPÓŁPRACY - ZLECENIODAWCA  (EN).pdf"}
          type="application/pdf"
          className="w-full max-w-4xl h-[80vh] border border-gray-300 rounded-lg"
        />
        <a
          href={language === "PL" ? "/A1 OGÓLNE WARUNKI WSPÓŁPRACY - ZLECENIODAWCA.pdf" : "/A1 OGÓLNE WARUNKI WSPÓŁPRACY - ZLECENIODAWCA  (EN).pdf"}
          download
