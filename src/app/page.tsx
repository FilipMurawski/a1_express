...
export default function Home() {
  return (
    ...
    <section id="home">
      <div className="relative flex flex-col items-start justify-start h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/Tapeta.jpg')" }}>
        <Section id="home" wrap="wrap">
          <h1 className="text-5xl font-bold text-[var(--primary-header-color)]">Profesjonalny Transport Krajowy i Międzynarodowy</h1>
          <h2 className="mt-4 text-2xl text-[var(--secondary-header-color)]">Bezpieczny, terminowy i elastyczny transport dostosowany do Twoich potrzeb</h2>
        </Section>
      </div>
    </section>
    <Section id="dlaczego" wrap="no-wrap">
      ...
      <div className="w-[50%] min-w-52 flex justify-center items-center space-y-10 flex-col">
        ...
        <div className="flex justify-center items-start space-x-[10%] space-y-[10%] w-[100%] text-[var(--primary-text-color)] flex-col sm:flex-row sm:space-y-0 ">
          <div className="flex justify-center flex-col items-center min-w-[calc(84%/4)] gap-4">
    ...
    <Section id="offer" wrap="no-wrap">
      <Image src="/o_nas.jpg" alt="young man" className="w-[80%] sm:w-[60%] min-w-[16rem] sm:-translate-x-20" width={1200} height={600}/>
      <div className="w-[50%] min-w-52 flex justify-center items-center space-y-10 flex-col">
