    ...
    <section id="home">
      <div className="relative flex flex-col items-start justify-start h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/Tapeta.jpg')" }}>
        <Section id="home" wrap="wrap">
          <h1 className="text-3xl sm:text-4xl md-text-4xl lg:text-5xl text-[var(--primary-header-color)] max-w-2xl font-bold">A1 Express</h1>
          <Header size="big">Bezpieczny i terminowy transport dostosowany do Twoich potrzeb.</Header>
        </Section>
      </div>
    </section>
