...
<section id="home" className="bg-gray-900 h-[60vh] sm:h-[80vh] md:h-screen flex flex-col">
  ...
  <div className="relative w-full flex-grow mt-16">
    <Image
      ...
      fill
      className="w-full md:object-cover object-contain max-h-fit"
    />
  </div>

  {/* Text Section */}
  <div className="w-full bg-gray-900 text-left p-5 pt-0 sm:pt-5">
...
<Image src="/dlaczego.jpg" alt="handshake" className="w-full  md:object-cover object-contain" width={1200} height={600}/>
    <Section id="dlaczego" wrap="wrap">     
      <div className="w-[100%] min-w-52 flex justify-center items-center space-y-10 flex-col">
        ...
        <div className="flex justify-center items-start sm:space-x-[10%] space-y-[10%] w-[80%] text-[var(--primary-text-color)] flex-col sm:flex-row sm:space-y-0 ">
          <div className="flex justify-center flex-col items-center min-w-[calc(100%/4)] sm:min-w-[calc(84%/4)] gap-4">
